...
datadir = "D:/MEGAsync/BArbeit/Data/cluster_results/pdc/"
...
subset = pd.read_csv("D:/MEGAsync/BArbeit/Data/cluster_results/done_pdc.csv", header=None, sep= ",")
...
for subset_entry in subset:
    ...
    split_len = int(subset_entry[2])
    split_part = int(subset_entry[3])


    cstart = int(subset_entry[4])
    cend = int(subset_entry[5])
    cstep = int(subset_entry[6])
    ...
    for clustercount in clist:
        ...
        dataset = "__data(small(" + subset_name + ")" + datasetname_origin
        data_file = config + dataset + split_string + "_clust.csv"
        ...
        #Expert-Score:
            ...
            label_position = int(cluster.keys().get_loc("cluster_data.label"))
            cluster_labels = cluster.iloc[:, [label_position, index_position]]
        ...
        # ClusterGrößen Analyse
            try:
                ...
                data_clust_file = config + dataset + split_string + "_clust.csv"
        ...
        # lade restliche, schon vorhandene ValidierungsDaten
            try:
                data_val_file = config + dataset + split_string + "_val.csv"
            ...
            summary_main[clustercount] = [datasetname_origin,
                                          subset_name,
                                          alt_name,
                                          split_string,
                                          clustercount,
            ...
            summary_add[clustercount] = [datasetname_origin,
                                          subset_name,
                                          alt_name,
                                          split_string,
            ...
            summary_full[clustercount] = [datasetname_origin,
                                          subset_name,
                                          alt_name,
                                          split_string,
            ...
            sumsum_main[nsum] =  [datasetname_origin,
                                          subset_name,
                                          alt_name,
                                          split_string,
            ...
            sumsum_add[nsum] = [datasetname_origin,
                                          subset_name,
                                          alt_name,
                                          split_string,
            ...
            sumsum_full[nsum] = [datasetname_origin,
                                          subset_name,
                                          alt_name,
                                          split_string,
            ...
            failed.append([subset_entry, data_file])
...
failed_data.to_csv("failed_pdc.csv")